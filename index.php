...
<body>
    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/11.jpeg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Notre siège</h2>
                <p class="animate__animated animate__fadeInUp">Le siège de l’association est établi à Uvira dans la province du Sud-Kivu.</p>
                <!-- <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a> -->
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/22.jpeg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">La durée</h2>
                <p class="animate__animated animate__fadeInUp">Inua Congo asbl est une association dotée d’une personnalité morale et à une durée indéterminée.</p>
                <!-- <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a> -->
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/33.jpeg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">La nature</h2>
                <p class="animate__animated animate__fadeInUp">Inua Congo asbl est une association laïque à caractère public et à but non lucratif, elle se réserve le droit de s’affilier à tout réseau œuvrant dans les mêmes domaines.</p>
                <!-- <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp">Get Started</a> -->
              </div>
            </div>
          </div>

          <div class="carousel-item" style="background-image: url(assets/img/hero-carousel/44.jpeg)">
            <div class="carousel-container">
              <div class="container">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
            <div class="about-col">
              <div class="img">
                <img src="assets/img/vision.jpeg" alt="" class="img-fluid">
    ...
    <section id="services">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header wow fadeInUp">
          <h3>Services</h3>
          <p>Inua Congo est une association qui offre plusieurs services dans différents secteurs pour la population d'Uvira et de la RDC en générale. </p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="200">
            ...
            <h4 class="title"><a href="">Information</a></h4>
            <p class="description">Nos séances se passent a la radio RTNC qui expliquent bien que nous sommes tous égaux devant la loi.</p>
          </div>
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="300">
            <div class="icon"><i class="bi bi-bar-chart"></i></div>
            <h4 class="title"><a href="">Mobilisation</a></h4>
            <p class="description">Nous effectuons aussi des campagnes des mobilisations de la population d'Uvira.</p>
          </div>
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="200">
            <div class="icon"><i class="bi bi-binoculars"></i></div>
            <h4 class="title"><a href="">Sensibilisation</a></h4>
            <p class="description">On sensibilise les gens que tout est possible devant la loi et nous sommes la pour les soutenir.</p>
          </div>
          <div class="col-lg-4 col-md-6 box" data-aos="fade-up" data-aos-delay="300">
            <div class="icon"><i class="bi bi-brightness-high"></i></div>
   ...
   <!--  -- ><section id="call-to-action">
    ...
    <section id="facts">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Preuves</h3>
          <p>Ce sont des factes de ce que nous avons déja faits pour la population d'Uvira et de la RDC en générale.</p>
        </header>
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            ...
            <p>Les gros bétails</p>
          </div>

        </div>

        <div class="facts-img">
          <img src="assets/img/preuve.JPG" alt="" class="img-fluid">
        </div>
    ...
    <section id="portfolio" class="section-bg">
      ...
      <div class=" col-lg-12">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-card">Mobilisation</li>
            <li data-filter=".filter-web">Agriculture</li>
          </ul>
        </div>
      </div>
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <figure>
              <img src="assets/img/vision.jpeg" class="img-fluid" alt="">
              <a href="assets/img/vision.jpeg" data-lightbox="portfolio" data-title="App 1" class="link-preview"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Séance avec la population</a></h4>
              <p>Encadrement</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <figure>
              <img src="assets/img/portfolio/agric_three.jpg" class="img-fluid" alt="">
              <a href="assets/img/portfolio/agric_three.jpg" class="link-preview portfolio-lightbox" data-gallery="portfolioGallery" title="Web 3"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Elles viennent du champ</a></h4>
              <p>champ</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <figure>
              ...
              <a href="assets/img/mission.jpeg" class="link-preview portfolio-lightbox" data-gallery="portfolioGallery" title="App 2"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Formation des membres</a></h4>
              <p>Formation</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <figure>
              <img src="assets/img/portfolio/agric_two.jpg" class="img-fluid" alt="">
              <a href="assets/img/portfolio/agric_two.jpg" class="link-preview portfolio-lightbox" data-gallery="portfolioGallery" title="Web 2"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">La récolte des arachides</a></h4>
              <p>Arachide</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            <figure>
              <img src="assets/img/objectif.jpeg" class="img-fluid" alt="">
              <a href="assets/img/objectif.jpeg" class="link-preview portfolio-lightbox" data-gallery="portfolioGallery" title="App 3"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Entrétien avec éleves</a></h4>
              <p>Ecole primaire</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            <figure>
              <img src="assets/img/portfolio/mob_three.jpg" class="img-fluid" alt="">
              <a href="assets/img/portfolio/mob_three.jpg" class="link-preview portfolio-lightbox" data-gallery="portfolioGallery" title="Card 1"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Mobilisation dans la plaine</a></h4>
              <p>Mobilisation</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">Atélier de discussion</a></h4>
              <p>Atélier</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            <figure>
              <img src="assets/img/portfolio/agric_one.jpg" class="img-fluid" alt="">
              <a href="assets/img/portfolio/agric_one.jpg" class="link-preview portfolio-lightbox" data-gallery="portfolioGallery" title="Web 1"><i class="bi bi-plus"></i></a>
              <a href="portfolio-details.html" class="link-details" title="More Details"><i class="bi bi-link"></i></a>
            </figure>

            <div class="portfolio-info">
              <h4><a href="portfolio-details.html">La récolte de maniocs</a></h4>
              <p>Manioc</p>
            </div>
          </div>
        </div>
      ...
      <div class="container" data-aos="zoom-in">
        ...
        <div class="clients-slider swiper-container">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="assets/img/clients/Acted.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/dpa_logo.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/monusco.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/oxfam.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/un_volunteers.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/WFP.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/unicef.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="assets/img/clients/unhcr.png" class="img-fluid" alt=""></div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="testimonials-slider swiper-container" data-aos="fade-up" data-aos-delay="100">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="assets/img/team_four.jpg" class="testimonial-img" alt="">
                <h3>Akili Dikonzo</h3>
                <h4>Freelancer</h4>
                <p>
                  <img src="assets/img/quote-sign-left.png" class="quote-sign-left" alt="">
    ...
    <section id="team">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          <h3>Equipe</h3>
          <p>Notre organisation est constitué de cette équipe qui est super motive:</p>
        </div>
    ...
    <section id="contact" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          ...
          <p>Voici nos contacts ci-dessus pour bien communiquer</p>
        </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Notre adresse</h3>
              <address>Quartier Rombe II, Avenue Fizi, République Démocratique du Congo</address>
            </div>
          </div>
        ...
        <div class="form">
          <form action="forms/contact.php" method="post" role="form" class="php-email-form">
            ...
            <div class="text-center"><button type="submit">Envoie votre message</button></div>
          </form>
        </div>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>Inua Congo</h3>
            <p>Le siège de l’association est établi à Uvira dans la province du Sud-Kivu, Le siège de Inua Congo asbl peut être transféré en tout autre lieu de la République Démocratique du Congo sur décision de l’Assemblée Générale après une consultation faite par le Bureau Exécutif</p>
          </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Inua Congo - 2021</strong>. Tous droits réservés
      </div>
      <div class="credits">
        <!--
